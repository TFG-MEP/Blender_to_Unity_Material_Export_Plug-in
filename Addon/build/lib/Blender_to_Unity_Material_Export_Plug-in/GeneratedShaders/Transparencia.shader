Shader "Custom/ShaderTransparencia_"
{
     Properties
    {
		...
		PrincipledBSDF_Specular("Specular", float) = 0.46727269887924194
		PrincipledBSDF_SpecularTint("SpecularTint", float) = 0.0
		PrincipledBSDF_Roughness("Roughness", float) = 0.21636363863945007
		...
		PrincipledBSDF_Alpha("Alpha", float) = 0.6254547834396362

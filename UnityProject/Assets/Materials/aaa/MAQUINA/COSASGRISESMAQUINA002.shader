Shader "Custom/ShaderCOSASGRISESMAQUINA002_"
{
     Properties
    {
		...
		ColorRamp_Color0("ColorRamp_Color0", Color) = (0.2757797525117866,0.27569791828676354,0.36395961066496835, 1.0)
		ColorRamp_Pos0("ColorRamp_Pos0", Float) = 0.0
		ColorRamp_Color1("ColorRamp_Color1", Color) = (0.41119970635920194,0.42758009765477245,0.5343771841903499, 1.0)
		ColorRamp_Pos1("ColorRamp_Pos1", Float) = 0.04090907797217369
		ColorRamp_Color2("ColorRamp_Color2", Color) = (0.6563820044593076,0.7205962236633512,0.8583418158723175, 1.0)

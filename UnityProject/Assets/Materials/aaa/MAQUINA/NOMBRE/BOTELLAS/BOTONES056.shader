Shader "Custom/ShaderBOTONES056_"
{
     Properties
    {
		...
		ColorRamp_Color0("ColorRamp_Color0", Color) = (0.2683390045497774,0.2655605046299822,0.17672348716709474, 1.0)
		ColorRamp_Pos0("ColorRamp_Pos0", Float) = 0.0
		ColorRamp_Color1("ColorRamp_Color1", Color) = (0.529351960984224,0.5241801167693996,0.33279831165451557, 1.0)

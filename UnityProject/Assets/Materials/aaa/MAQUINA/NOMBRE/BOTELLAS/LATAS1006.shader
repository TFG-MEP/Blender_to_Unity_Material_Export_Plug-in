Shader "Custom/ShaderLATAS1006_"
{
     Properties
    {
		...
		ColorRamp_Color0("ColorRamp_Color0", Color) = (0.48362842779380744,0.40456339768794125,0.10401827697916781, 1.0)
		ColorRamp_Pos0("ColorRamp_Pos0", Float) = 0.0
		ColorRamp_Color1("ColorRamp_Color1", Color) = (0.8496504564934965,0.6978932363460799,0.16360855491407506, 1.0)
		ColorRamp_Pos1("ColorRamp_Pos1", Float) = 0.043182093650102615
		ColorRamp_Color2("ColorRamp_Color2", Color) = (0.8584711648393886,0.8895064168536087,0.36370143812489225, 1.0)
		ColorRamp_Pos2("ColorRamp_Pos2", Float) = 0.48636412620544434
		// Add properties
    }

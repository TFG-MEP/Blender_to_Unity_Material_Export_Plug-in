Shader "Custom/ShaderBOTELLA2009_"
{
     Properties
    {
		...
		ColorRamp_Color0("ColorRamp_Color0", Color) = (0.059362434706100406,0.3465935093088546,0.11866438161736474, 1.0)
		ColorRamp_Pos0("ColorRamp_Pos0", Float) = 0.0
		ColorRamp_Color1("ColorRamp_Color1", Color) = (0.24683612036088148,0.8895064168536087,0.5259733500718832, 1.0)

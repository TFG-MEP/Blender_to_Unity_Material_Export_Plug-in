Shader "Custom/ShaderBOTONES042_"
{
     Properties
    {
		...
		ColorRamp_Color0("ColorRamp_Color0", Color) = (0.20861274482753478,0.17928071255546116,0.3465980625521081, 1.0)
		ColorRamp_Pos0("ColorRamp_Pos0", Float) = 0.0
		ColorRamp_Color1("ColorRamp_Color1", Color) = (0.620591845978832,0.4516196617521831,0.8895064168536087, 1.0)

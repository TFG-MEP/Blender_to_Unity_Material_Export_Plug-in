Shader "Custom/ShaderBOTONES052_"
{
     Properties
    {
		...
		ColorRamp_Color0("ColorRamp_Color0", Color) = (0.37603626278953767,0.43844763708019063,0.4639800613460248, 1.0)
		ColorRamp_Pos0("ColorRamp_Pos0", Float) = 0.0
		ColorRamp_Color1("ColorRamp_Color1", Color) = (0.6085693625136284,0.6748244049234782,0.6358787888057902, 1.0)

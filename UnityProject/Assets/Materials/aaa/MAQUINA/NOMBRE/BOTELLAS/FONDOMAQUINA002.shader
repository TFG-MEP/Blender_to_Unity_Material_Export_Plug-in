Shader "Custom/ShaderFONDOMAQUINA002_"
{
     Properties
    {
		...
		ColorRamp_Color0("ColorRamp_Color0", Color) = (0.17035348074914278,0.19419642414916458,0.2039412890624997, 1.0)
		ColorRamp_Pos0("ColorRamp_Pos0", Float) = 0.0
		ColorRamp_Color1("ColorRamp_Color1", Color) = (0.334511256498496,0.36853821441101625,0.3485388509891288, 1.0)
		ColorRamp_Pos1("ColorRamp_Pos1", Float) = 0.6363639831542969
		// Add properties
    }
...
float PrincipledBSDF_EmissionStrength,float PrincipledBSDF_Alpha, float3 PrincipledBSDF_Normal,float3 PrincipledBSDF_ClearcoatNormal, float3 PrincipledBSDF_Tangent, float PrincipledBSDF_Weight)
    ...
    return (vec.x + vec.y + vec.z) / 3.0;
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				Color_Ramp ColorRamp = color_ramp(ColorRamp_Fac, 2, 0, ColorRamp_ramp, ColorRamp_pos);

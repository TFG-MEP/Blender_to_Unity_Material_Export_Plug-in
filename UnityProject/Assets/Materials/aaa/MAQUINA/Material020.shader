Shader "Custom/ShaderMaterial020_"
{
     Properties
    {
		...
		ColorRamp_Color0("ColorRamp_Color0", Color) = (0.18356553569680234,0.3639596448333836,0.33265909114596653, 1.0)
		ColorRamp_Pos0("ColorRamp_Pos0", Float) = 0.0
		ColorRamp_Color1("ColorRamp_Color1", Color) = (0.25803827220877434,0.5343772416601791,0.48636414154408386, 1.0)
		ColorRamp_Pos1("ColorRamp_Pos1", Float) = 0.04090907797217369
		ColorRamp_Color2("ColorRamp_Color2", Color) = (0.3862924455585675,0.8583418158723175,0.6270832047562467, 1.0)

Shader "Custom/ShaderTestUVs001_"
{
     Properties
    {
		...
		RGB_Color("Color", Color) = (0.2267111325613825,0.3156942111697138,0.8847658145305918, 1.0)
		CheckerTexture_Color2("Color2", Color) = (1.0,1.0,1.0, 1.0)

Shader "Custom/ShaderMixVector_"
{
     Properties
    {
        _NormalTex("Normal Map", 2D) = "bump" {}
        Mix_Factor_Float("Factor_Float", float) = 1.0
		Mix_Factor_Vector("Factor_Vector", Vector) = (0.699999988079071, 0.11999999731779099, 0.7799999713897705)
		Mix_A_Float("A_Float", float) = 10.0
		Mix_B_Float("B_Float", float) = 0.0
		Mix_A_Vector("A_Vector", Vector) = (0.0, 0.0, 0.0)
		Mix_B_Vector("B_Vector", Vector) = (1.0, 1.0, 1.0)
		...
		Mix_Factor_Mode_Uniform("Uniform Vector Mix", Int) = 0
		// Add properties
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Mix_vector mix_vector(float mixFactorFloat, float3 mixFactorVector, float floatA, float floatB, float3 vectorA, float3 vectorB, float4 colorA, float4 colorB, bool clampFactor, bool factorModeUniform) {
                Mix_vector mixed;
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                Mix_vector Mix_vector = mix_vector(Mix_Factor_Float, Mix_Factor_Vector, Mix_A_Float, Mix_B_Float, Mix_A_Vector, Mix_B_Vector, Mix_A_Color, Mix_B_Color, Mix_Clamp_Factor, Mix_Factor_Mode_Uniform);
				float4 MaterialOutput_Surface = float3_to_float4(Mix_vector.Result);
				// Call methods

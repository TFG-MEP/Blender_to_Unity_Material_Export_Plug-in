Shader "Custom/ShaderVoronoi_"
{
     Properties
    {
        _NormalTex("Normal Map", 2D) = "bump" {}
        VoronoiTexture_W("W", float) = 2.0
		VoronoiTexture_Scale("Scale", float) = 5.199999809265137
		VoronoiTexture_Smoothness("Smoothness", float) = 0.2799999713897705

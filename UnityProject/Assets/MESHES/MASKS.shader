Shader "Custom/ShaderMASKS_"
{
     Properties
    {
        _NormalTex("Normal Map", 2D) = "bump" {}
        Image_Texture_002_Image("Texture", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D Image_Texture_002_Image;
			...
			sampler2D Image_Texture_003_Image;
			float PrincipledBSDF_Specular;
			float PrincipledBSDF_SpecularTint;
			sampler2D Image_Texture_004_Image;
    ...
    return (vec.x + vec.y + vec.z) / 3.0;
			...
			Normal_Map_struct normal_map(float strenght,float3 color){
                float3 normal=UnpackNormal(float4(color,1));
                normal.rg*=strenght;
...
float PrincipledBSDF_EmissionStrength,float PrincipledBSDF_Alpha, float3 PrincipledBSDF_Normal,float3 PrincipledBSDF_ClearcoatNormal, float3 PrincipledBSDF_Tangent, float PrincipledBSDF_Weight)
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				Image_Texture_struct Image_Texture_002 = image_texture(ImageTexture002_Vector, Image_Texture_002_Image);
				float3 PrincipledBSDF_BaseColor = Image_Texture_002.Color;
				float3 ImageTexture003_Vector = float3(i.uv,0);
				Image_Texture_struct Image_Texture_003 = image_texture(ImageTexture003_Vector, Image_Texture_003_Image);
				float PrincipledBSDF_Metallic = float3_to_float(Image_Texture_003.Color);
				float3 ImageTexture004_Vector = float3(i.uv,0);
				Image_Texture_struct Image_Texture_004 = image_texture(ImageTexture004_Vector, Image_Texture_004_Image);
				float PrincipledBSDF_Roughness = float3_to_float(Image_Texture_004.Color);
				...
				float3 NormalMap_Color = Image_Texture_001.Color;

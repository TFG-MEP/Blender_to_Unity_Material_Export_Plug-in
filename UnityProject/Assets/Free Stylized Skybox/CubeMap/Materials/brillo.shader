Shader "Custom/Shaderbrillo_"
{
     Properties
    {
		...
		PrincipledBSDF_Emission("Emission", Color) = (0.5551674194702031,0.0,1.0, 1.0)
		PrincipledBSDF_EmissionStrength("EmissionStrength", float) = 18.799999237060547
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile_local USE_EMISSION_ON 

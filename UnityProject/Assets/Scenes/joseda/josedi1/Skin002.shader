Shader "Custom/ShaderSkin002_"
{
     Properties
    {
		...
		CheckerTexture_Scale("Scale", float) = 81.49999237060547
		...
		Color_Ramp_Pos1("Color_Ramp_Pos1", Float) = 0.4081817865371704
		Color_Ramp_Color2("Color_Ramp_Color2", Color) = (0.7195821983749527,0.14825765773435431,0.310859240710854, 1.0)
		Color_Ramp_Pos2("Color_Ramp_Pos2", Float) = 0.7627972364425659
		...
		PrincipledBSDF_Metallic("Metallic", float) = 0.7142857313156128
		PrincipledBSDF_Specular("Specular", float) = 0.2478991448879242
		PrincipledBSDF_SpecularTint("SpecularTint", float) = 0.0
		PrincipledBSDF_Roughness("Roughness", float) = 0.33193278312683105
...
float PrincipledBSDF_EmissionStrength,float PrincipledBSDF_Alpha, float3 PrincipledBSDF_Normal,float3 PrincipledBSDF_ClearcoatNormal, float3 PrincipledBSDF_Tangent, float PrincipledBSDF_Weight)
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				float3 CheckerTexture_Vector = Image_Texture.Color;

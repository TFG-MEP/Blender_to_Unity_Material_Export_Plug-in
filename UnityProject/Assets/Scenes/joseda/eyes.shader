Shader "Custom/Shadereyes_"
{
     Properties
    {
		...
		Mapping_Scale("Scale", Vector) = (0.9900000095367432, 0.9900000095367432, 0.9900000095367432)
		VoronoiTexture_W("W", float) = 0.0
		VoronoiTexture_Scale("Scale", float) = -6.169999122619629
		...
		Color_Ramp_Color1("Color_Ramp_Color1", Color) = (1.0,0.16588148291562568,0.15505815726940633, 1.0)
		Color_Ramp_Pos1("Color_Ramp_Pos1", Float) = 0.39090949296951294
		...
		PrincipledBSDF_Emission("Emission", Color) = (0.4762427498524918,0.15226720466967505,0.14651755586672113, 1.0)
		PrincipledBSDF_EmissionStrength("EmissionStrength", float) = 1.5999997854232788
...
float PrincipledBSDF_EmissionStrength,float PrincipledBSDF_Alpha, float3 PrincipledBSDF_Normal,float3 PrincipledBSDF_ClearcoatNormal, float3 PrincipledBSDF_Tangent, float PrincipledBSDF_Weight)
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				float3 VoronoiTexture_Vector = Mapping.Vector;

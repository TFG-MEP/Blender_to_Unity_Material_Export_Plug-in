Shader "Custom/Shadercuerpo_"
{
     Properties
    {
        ...
        PrincipledBSDF_BaseColor("BaseColor", Color) = (0.35736925266196173,0.7650357479822566,0.4769788863686596, 1.0)
		...
		Color_Ramp_001_Color0("Color_Ramp_001_Color0", Color) = (0.16820115088254523,0.25310078984026335,0.3420113058976117, 1.0)
		Color_Ramp_001_Pos0("Color_Ramp_001_Pos0", Float) = 0.0
		Color_Ramp_001_Color1("Color_Ramp_001_Color1", Color) = (0.34765577878950255,0.7597169845972478,0.6485534920654037, 1.0)
		Color_Ramp_001_Pos1("Color_Ramp_001_Pos1", Float) = 0.30454564094543457
		// Add properties
    }
...
float PrincipledBSDF_EmissionStrength,float PrincipledBSDF_Alpha, float3 PrincipledBSDF_Normal,float3 PrincipledBSDF_ClearcoatNormal, float3 PrincipledBSDF_Tangent, float PrincipledBSDF_Weight)
    ...
    return (vec.x + vec.y + vec.z) / 3.0;
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				float ColorRamp001_Fac = float3_to_float(Shader_to_RGB.Color);
				...
				Color_Ramp_struct Color_Ramp_001 = color_ramp(ColorRamp001_Fac, 2, 0, Color_Ramp_001_ramp, Color_Ramp_001_pos);
				float4 MaterialOutput_Surface = float3_to_float4(Color_Ramp_001.Color);
				// Call methods

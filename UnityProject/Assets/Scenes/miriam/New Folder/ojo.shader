Shader "Custom/Shaderojo_"
{
     Properties
    {
        ...
        RGB_Color("Color", Color) = (0.9073073297630653,0.8597587583758729,0.6200238968972404, 1.0)
		// Add properties
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				float4 MaterialOutput_Surface = float3_to_float4(RGB.Color);
				// Call methods

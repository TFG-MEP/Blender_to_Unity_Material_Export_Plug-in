Shader "Custom/Shaderpelo_"
{
     Properties
    {
        ...
        PrincipledBSDF_BaseColor("BaseColor", Color) = (0.28058353344873166,0.7650333567589396,0.6037410976730537, 1.0)
		...
		PrincipledBSDF_Emission("Emission", Color) = (1.0,1.0,1.0, 1.0)
		...
		Color_Ramp_Color0("Color_Ramp_Color0", Color) = (0.22743733305486133,0.10066311864723895,0.09002177339287655, 1.0)
		Color_Ramp_Pos0("Color_Ramp_Pos0", Float) = 0.0
		Color_Ramp_Color1("Color_Ramp_Color1", Color) = (0.46144624555603725,0.2580106763878403,0.21581475411302747, 1.0)
		Color_Ramp_Pos1("Color_Ramp_Pos1", Float) = 0.022727273404598236
		Color_Ramp_Color2("Color_Ramp_Color2", Color) = (0.6388781984067256,0.3760724350185143,0.28613986670820857, 1.0)
		Color_Ramp_Pos2("Color_Ramp_Pos2", Float) = 0.07954546064138412
		Color_Ramp_Color3("Color_Ramp_Color3", Color) = (1.0,0.5000691803135289,0.29844461161914243, 1.0)
		Color_Ramp_Pos3("Color_Ramp_Pos3", Float) = 0.1409090906381607
		// Add properties
    }
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			float4 Color_Ramp_Color3;
			float Color_Ramp_Pos3;
			// Add variables
...
float PrincipledBSDF_EmissionStrength,float PrincipledBSDF_Alpha, float3 PrincipledBSDF_Normal,float3 PrincipledBSDF_ClearcoatNormal, float3 PrincipledBSDF_Tangent, float PrincipledBSDF_Weight)
    ...
    return (vec.x + vec.y + vec.z) / 3.0;
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				Color_Ramp_ramp[3]=Color_Ramp_Color3;
				Color_Ramp_pos[3]=Color_Ramp_Pos3;
				Color_Ramp_struct Color_Ramp = color_ramp(ColorRamp_Fac, 4, 0, Color_Ramp_ramp, Color_Ramp_pos);

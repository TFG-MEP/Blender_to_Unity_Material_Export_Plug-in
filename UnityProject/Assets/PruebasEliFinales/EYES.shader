Shader "Custom/ShaderEYES_"
{
     Properties
    {
		...
		PrincipledBSDF_Emission("Emission", Color) = (0.4070543835675022,1.000000054186039,0.8509431632089803, 1.0)
		PrincipledBSDF_EmissionStrength("EmissionStrength", float) = 15.0

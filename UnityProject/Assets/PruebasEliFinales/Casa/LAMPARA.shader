Shader "Custom/ShaderLAMPARA_"
{
     Properties
    {
        ...
        BSDFPrincipista_BaseColor("BaseColor", Color) = (0.27557412230215983,0.2924088815310329,0.47674545612235447, 1.0)
		...
		BSDFPrincipista_Metallic("Metallic", float) = 0.7983193397521973
		BSDFPrincipista_Specular("Specular", float) = 0.5
		BSDFPrincipista_SpecularTint("SpecularTint", float) = 0.0
		BSDFPrincipista_Roughness("Roughness", float) = 0.4159663915634155

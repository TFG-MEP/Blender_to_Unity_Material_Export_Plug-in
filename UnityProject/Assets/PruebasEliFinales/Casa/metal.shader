Shader "Custom/Shadermetal_"
{
     Properties
    {
        ...
        BSDFPrincipista_BaseColor("BaseColor", Color) = (0.9035454676387557,0.684578073331912,0.3087907981848877, 1.0)
		...
		BSDFPrincipista_Metallic("Metallic", float) = 0.9411764740943909
		BSDFPrincipista_Specular("Specular", float) = 0.5
		BSDFPrincipista_SpecularTint("SpecularTint", float) = 0.0
		BSDFPrincipista_Roughness("Roughness", float) = 0.2983193099498749

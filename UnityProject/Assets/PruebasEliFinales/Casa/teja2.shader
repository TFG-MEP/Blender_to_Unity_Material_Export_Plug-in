Shader "Custom/Shaderteja2_"
{
     Properties
    {
        ...
        BSDFPrincipista_BaseColor("BaseColor", Color) = (0.03450091517975165,0.2956007661141122,0.7158629564494053, 1.0)
		...
		BSDFPrincipista_Metallic("Metallic", float) = 0.17499999701976776
		BSDFPrincipista_Specular("Specular", float) = 0.5
		BSDFPrincipista_SpecularTint("SpecularTint", float) = 0.0
		BSDFPrincipista_Roughness("Roughness", float) = 0.75

Shader "Custom/Shaderteja1_"
{
     Properties
    {
        ...
        BSDFPrincipista_BaseColor("BaseColor", Color) = (0.037795616964969254,0.3563074511053799,0.8833943296965204, 1.0)
		...
		BSDFPrincipista_Roughness("Roughness", float) = 0.5

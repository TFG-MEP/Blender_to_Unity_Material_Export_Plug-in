Shader "Custom/ShaderMaterial001_"
{
     Properties
    {
        ...
        PrincipledBSDF_BaseColor("BaseColor", Color) = (0.2525611466340216,0.9175619178884783,0.40019460600114104, 1.0)
		PrincipledBSDF_Subsurface("Subsurface", float) = 0.019999999552965164
		...
		PrincipledBSDF_Roughness("Roughness", float) = 0.5416666269302368
		...
		PrincipledBSDF_Transmission("Transmission", float) = 1.0

Shader "Custom/ShaderMaterial002_"
{
     Properties
    {
        ...
        PrincipledBSDF_BaseColor("BaseColor", Color) = (0.04390073016225456,0.04390073016225456,0.04390073016225456, 1.0)
		PrincipledBSDF_Subsurface("Subsurface", float) = 0.0
		PrincipledBSDF_SubsurfaceRadius("SubsurfaceRadius", Vector) = (0.0, 46.19999694824219, 0.10000000149011612)
		PrincipledBSDF_SubsurfaceColor("SubsurfaceColor", Color) = (0.20637579674468953,0.20637579674468953,0.20637579674468953, 1.0)
		...
		PrincipledBSDF_Specular("Specular", float) = 0.8333333730697632
		PrincipledBSDF_SpecularTint("SpecularTint", float) = 0.0
		PrincipledBSDF_Roughness("Roughness", float) = 0.4758453965187073

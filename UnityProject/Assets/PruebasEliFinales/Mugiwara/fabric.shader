Shader "Custom/Shaderfabric_"
{
     Properties
    {
        ...
        PrincipledBSDF_BaseColor("BaseColor", Color) = (0.9035454676387557,0.10886918011107281,0.14911888467418552, 1.0)
		...
		PrincipledBSDF_Specular("Specular", float) = 0.5256410241127014
		PrincipledBSDF_SpecularTint("SpecularTint", float) = 0.0
		PrincipledBSDF_Roughness("Roughness", float) = 0.6666666865348816

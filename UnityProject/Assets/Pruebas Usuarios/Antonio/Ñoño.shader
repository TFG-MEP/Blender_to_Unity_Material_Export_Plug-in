Shader "Custom/ShaderÑoño_"
{
     Properties
    {
        ...
        VoronoiTexture_W("W", float) = 26.999998092651367
		VoronoiTexture_Scale("Scale", float) = 377.4999694824219
		VoronoiTexture_Smoothness("Smoothness", float) = 1.0
		VoronoiTexture_Exponent("Exponent", float) = 6.899999618530273
		VoronoiTexture_Randomness("Randomness", float) = 32.0
		Color_Ramp_Color0("Color_Ramp_Color0", Color) = (0.0,0.0,0.0, 1.0)
		Color_Ramp_Pos0("Color_Ramp_Pos0", Float) = 0.29909375309944153
		Color_Ramp_Color1("Color_Ramp_Color1", Color) = (1.0,0.5468032904988491,0.0, 1.0)
		Color_Ramp_Pos1("Color_Ramp_Pos1", Float) = 0.5558919906616211
		...
		PrincipledBSDF_SubsurfaceIOR("SubsurfaceIOR", float) = 1.0099999904632568
		PrincipledBSDF_SubsurfaceAnisotropy("SubsurfaceAnisotropy", float) = 0.0
		PrincipledBSDF_Metallic("Metallic", float) = 0.5
		PrincipledBSDF_Specular("Specular", float) = 0.638972818851471
		PrincipledBSDF_SpecularTint("SpecularTint", float) = 1.0
		PrincipledBSDF_Roughness("Roughness", float) = 0.0
		PrincipledBSDF_Anisotropic("Anisotropic", float) = 0.41691842675209045
		PrincipledBSDF_AnisotropicRotation("AnisotropicRotation", float) = 0.4864048361778259
		PrincipledBSDF_Sheen("Sheen", float) = 0.2598187327384949
		PrincipledBSDF_SheenTint("SheenTint", float) = 0.5
		PrincipledBSDF_Clearcoat("Clearcoat", float) = 0.45619338750839233
		PrincipledBSDF_ClearcoatRoughness("ClearcoatRoughness", float) = 0.5224471092224121
		PrincipledBSDF_IOR("IOR", float) = 1.4500000476837158
		PrincipledBSDF_Transmission("Transmission", float) = 0.2839879095554352
		PrincipledBSDF_TransmissionRoughness("TransmissionRoughness", float) = 0.0
		PrincipledBSDF_Emission("Emission", Color) = (0.5051299520717926,0.3231445822419172,0.0, 1.0)
		PrincipledBSDF_EmissionStrength("EmissionStrength", float) = 0.7999989986419678
		PrincipledBSDF_Alpha("Alpha", float) = 1.0
		NormalMap_Strength("Strength", float) = 1.0
		NormalMap_Color("Color", Color) = (0.865385761427706,1.0,0.1949637008420877, 1.0)

Shader "Custom/ShaderMaterial002_"
{
     Properties
    {
        ...
        PrincipledBSDF_BaseColor("BaseColor", Color) = (0.9035454676387557,0.0,0.8768832523001564, 1.0)
		...
		PrincipledBSDF_Emission("Emission", Color) = (0.9492536606069408,0.0,0.7259979395151174, 1.0)
		PrincipledBSDF_EmissionStrength("EmissionStrength", float) = 20.0
